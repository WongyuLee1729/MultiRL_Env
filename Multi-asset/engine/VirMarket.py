...
# candle_acc_trade_price -> acc_price 
# acc_volume -> candle_acc_trade_volume
# closeing_price -> trade_price 
# date_time -> candle_data_time_kst 
# 
...
class VirtualMarket:
    ...
    def initialize(self, end=None, count=100, budget=0, market="KRW-BTC"):
        """
    ...
    def get_balance(self):
        ...
        quote = None
        try:
            quote = {self.data[self.turn_count]["market"]: self.data[self.turn_count]["closing_price"]} # trade_price 
        ...
        asset_info["date_time"] = self.data[self.turn_count]["date_time"] # candle_date_time_kst = date_time
        return asset_info
    ...
    def handle_request(self, request):
        ...
        if self.is_initialized is not True:
            ...
            return None
        now = self.data[self.turn_count]["date_time"]  # candle_date_time_kst = date_time
        self.turn_count += 1
