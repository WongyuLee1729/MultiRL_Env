...
if __name__ == '__main__':
    ...
    end_date = "2021-06-30T07:30:00"
    
    dr = SimulationDataProvider()
    
    dr.initialize_simulation(end=end_date, count=100)
    ...
    strategy.initialize(50000, 500) # 초기화 - 예산 및 최소 주문 금액 입력 
    
    for _ in range(6):
        strategy.update_trading_info(dr.get_info())
